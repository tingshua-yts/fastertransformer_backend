...
if __name__ == "__main__":
    ...
    inputs.append(tritongrpcclient.InferInput("input_ids", input_ids.shape, "UINT32"))
    inputs[0].set_data_from_numpy(input_ids)

    ## 2.2) input_length
    inputs.append(tritongrpcclient.InferInput("input_lengths", input_lengths.shape, "UINT32"))
    ...
    inputs.append(tritongrpcclient.InferInput("request_output_len", output_len_np.shape, "UINT32"))
    inputs[2].set_data_from_numpy(output_len_np)


    # 3) 设置output
    outputs = []
    outputs.append(tritongrpcclient.InferRequestedOutput("output_ids"))
